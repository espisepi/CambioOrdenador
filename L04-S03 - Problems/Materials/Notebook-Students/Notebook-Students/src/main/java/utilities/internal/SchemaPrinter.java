...
public class SchemaPrinter {
	...
	protected static void printValue(final StringBuffer buffer,
			final Object value, final boolean summary) {
		if (SchemaPrinter.isPrimitive(value) || SchemaPrinter.isEnum(value))
			...
			SchemaPrinter.printCollection(buffer, (Collection<?>) value,
					summary);
		else
			SchemaPrinter.printRecord(buffer, value, true);
	}

	protected static void printRecord(final StringBuffer buffer,
			final Object obj, final boolean summary) {
	...
	protected static void printFieldsInClazz(final StringBuffer buffer,
			final Class<?> clazz, final Object obj) {
		Field fields[];
		String name;
		Class<?> type;
		Object value;
	...
	protected static void printPrimitive(final StringBuffer buffer,
			final Object value, final boolean summary) {
		String left, right;
	...
	protected static void printArray(final StringBuffer buffer,
			final Object[] value, final boolean summary) {
		String separator;
	...
	private static void printCollection(final StringBuffer buffer,
			final Collection<?> value, final boolean summary) {
		String separator;
	...
	protected static void printType(final StringBuffer buffer,
			final Class<?> clazz) {
		String type;
	...
	protected static boolean isPrimitive(final Object obj) {
		...
		result = (obj == null || obj instanceof String || obj instanceof Number
				|| obj instanceof Character || obj instanceof Boolean
				|| obj instanceof java.util.Date
				|| obj instanceof java.sql.Date || obj instanceof Timestamp);
	...
	protected static boolean isValue(final Object obj) {
		...
		result = (SchemaPrinter.isPrimitive(obj) || SchemaPrinter.isArray(obj) || SchemaPrinter
				.isEnum(obj));
